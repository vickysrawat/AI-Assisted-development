...
<!-- Hybrid: extract detectable signals from code/config (rate limiting, response caching,
     k8s/Docker resource limits, health/readiness probes, HSTS/CORS); the targets/SLAs are
     usually human knowledge — captured via the Step 0.5 NFR questions or flagged. -->
