...
<!-- container | azure-app-service | aws-ecs | kubernetes | bare-wsgi | mixed -->
...
## Runtime Configuration (WSGI/ASGI)
...
| Worker count | |
| Static files strategy (whitenoise/CDN) | |
| collectstatic in deploy | |
| Health probe path | |
