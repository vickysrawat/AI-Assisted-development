...
> **Related specs:** Consent Category B — gate before reading changed entry-point files (`skills/shared/source-file-consent.md`). Severity vocabulary per `skills/shared/business-context-severity.md`.
