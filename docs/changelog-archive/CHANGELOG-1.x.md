# Changelog — 1.x archive

Historical releases prior to 2.0.0, moved out of the main CHANGELOG to keep it scannable.
For 2.0.0 and later, see [../../CHANGELOG.md](../../CHANGELOG.md).
