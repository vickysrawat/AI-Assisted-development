...
## Bounded context
Static code analysis with persistent tracking. Detects new defects, marks previously-found defects as fixed. Writes HTML + Markdown reports + running ledger into `CodeReviews/`. Cache-aware — only re-scans changed files.
