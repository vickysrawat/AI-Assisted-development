...
Run the dream-status skill to produce a health report for all Dream plugin
...
Read `$PLUGIN_DIR/skills/dream-status/SKILL.md` and follow its instructions exactly.
