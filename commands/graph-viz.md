...
argument-hint: "[--3d]  —  omit to be prompted (2D recommended; CI renders 2D); --3d requires a vendored WebGL lib at .claude/graph/vendor/"
---
...
Read `$PLUGIN_DIR/skills/graph-viz/SKILL.md` and follow its instructions exactly.
