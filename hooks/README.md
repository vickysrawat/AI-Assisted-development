...
`dream-init` installs all hooks **by default** (ADR 0009 — defaults are policy); opt-out via `--no-hooks` is recorded and attributed in architecture-deployment.md. Manual installation:
